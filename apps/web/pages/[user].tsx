            ...
            {user.away ? (
              ...
              eventTypes.map((type) => (
                <div
                  ...
                  className="hover:border-brand group relative rounded-lg border border-neutral-200 bg-white shadow hover:bg-gray-50 dark:border-neutral-700 dark:bg-gray-800 dark:hover:border-neutral-600">
                  <ArrowRightIcon className="absolute right-3 top-3 h-4 w-4 text-black opacity-0 transition-opacity group-hover:opacity-100 dark:text-white" />
